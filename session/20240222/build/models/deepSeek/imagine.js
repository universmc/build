...
async function imagineCompletion() {
  try {
    const result = await completeText("deepseek", "Imagine un site web bien stylé.", { temperature: 0.7 });
    console.log("Résultat:\n", result);
  } catch (error) {
    console.error("Erreur imagineCompletion:", error);
  }
}
