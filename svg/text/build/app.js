...
// Convertir Markdown en texte SVG simple
const svgText = `
<svg width="400" height="200" xmlns="http://www.w3.org/2000/svg">
    <text x="10" y="50" font-family="Arial" font-size="40">${markdownText.replace(/\n/g, ' ').replace(/[#*]/g, '')}</text>
</svg>`;

// Charger le SVG avec SVGLoader
const loader = new THREE.SVGLoader();
loader.load(
    'data:image/svg+xml;base64,' + btoa(svgText), // Charger le SVG en mémoire
    (data) => {
